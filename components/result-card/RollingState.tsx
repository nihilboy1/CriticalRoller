...
const RollingState: React.FC<RollingStateProps> = ({ mode }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div className={`font-rajdhani font-bold text-8xl md:text-9xl ${rollingColor} animate-pulse`}>
        {displayNumber.toString().padStart(2, '0')}
      </div>
      <p className="mt-4 text-[#A0A0A0] text-xl font-rajdhani uppercase tracking-wider">Rolando...</p>
    </div>
  );
};
