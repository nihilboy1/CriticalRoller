...
import { BludgeoningIcon, PiercingIcon, SlashingIcon, MagicalIcon } from '../constants/icons';
...
const DamageTypeSelector: React.FC<DamageTypeSelectorProps> = ({ selectedType, onSelect, disabled }) => {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-3xl">
      {(Object.values(DamageType)).map((type) => {
        const isSelected = selectedType === type;
        const buttonClass = isSelected
          ? 'bg-lime-500 text-white ring-4 ring-lime-500'
